class Preloader extends Phaser.State {
    ...
    loadResources() {
        ...
        this.game.load.image('ai2', 'assets/button_train-size.png');
        this.game.load.image('ai5', 'assets/button_train-size2.png');
        this.game.load.image('ai10', 'assets/button_train-size3.png');
        this.game.load.image('getData', 'assets/button_get-data.png')
